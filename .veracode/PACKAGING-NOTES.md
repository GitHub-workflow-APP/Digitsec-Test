...
Note that plugins may create a `.sfdx` folder that we should ignore.
This should be fixed by [Ignore folders starting with `.`](https://veracode.atlassian.net/browse/STATB-635) .
